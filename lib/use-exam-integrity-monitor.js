...
const FIRST_INACTIVITY_WARNING_SECONDS = 60;
const ESCALATION_INACTIVITY_WARNING_SECONDS = 120;
const INACTIVITY_AUTO_SUBMIT_SECONDS = 180;
const ACTIVITY_CHECK_INTERVAL_MS = 5000;
